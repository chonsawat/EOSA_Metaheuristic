...
from models.multiple_solution.utils.history import History
from models.multiple_solution.problem import Problem
from models.multiple_solution.utils.termination import Termination
...
class Optimizer:
    ...
    def __init__(self, problem, root_paras, kwargs):
        """
        Args:
        ...
        self.problem_size = root_paras["problem_size"]
